...
public class ClienteMultihiloDos {
    ...
    public ClienteMultihiloDos(String host, int puerto) {
        this.host = host;
        this.puerto = puerto;
    }
    ...
    public static void main(String[] args) {
        ClienteMultihiloDos clienteMultihilo = new ClienteMultihiloDos("localhost", 49171); // localhost -> 127.0.0.1
